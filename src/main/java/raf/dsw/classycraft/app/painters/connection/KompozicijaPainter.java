...
public class KompozicijaPainter extends ConnectionPainter {
    ...
    public void draw(Graphics2D g, DiagramView dv) {
        ...
        g.draw(line);
        nacrtajStrelicu(g);
        nacrtajPopunjenRomb(g);
    }

    public void nacrtajPopunjenRomb(Graphics2D g) {
        ...
        path.moveTo(getConnection().getStartPoint().x,getConnection().getStartPoint().y);
        path.lineTo(getConnection().getStartPoint().x + 7,getConnection().getStartPoint().y - 5);
        path.lineTo(getConnection().getStartPoint().x + 14,getConnection().getStartPoint().y);
        path.lineTo(getConnection().getStartPoint().x + 7,getConnection().getStartPoint().y + 5);
        path.closePath();*/
